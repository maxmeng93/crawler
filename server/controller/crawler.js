...
module.exports = {
  async getChinaPopulation(ctx) {
    ...
    try {
      ...
      await request({
        url:
          "https://www.kuaiyilicai.com/stats/global/yearly_per_country/g_population_total/chn.html"
      }).then(body => {
      ...
      await request({
        url:
          "https://www.kuaiyilicai.com/stats/global/yearly_per_country/g_population_male/chn.html"
      }).then(body => {
        let $ = cheerio.load(body);
        let tr = $("table.table tbody tr");
